...
setwd("~/Dropbox/UBC/Side_Projects/Arnaud_Anteaters/Scripts")
load("~/Dropbox (Personal)/UBC/Side_Projects/Arnaud_Anteaters/Scripts/Anteater_GPS_Data.Rda")
...
jenn <- DATA[[23]]
load("~/Dropbox (Personal)/UBC/Side_Projects/Arnaud_Anteaters/Scripts/Results/Fits/Fits_Jennifer 262.rda")
fit_jenn <- FIT

scott <- DATA[[39]]
load("~/Dropbox (Personal)/UBC/Side_Projects/Arnaud_Anteaters/Scripts/Results/Fits/Fits_Scott.rda")
fit_scott <- FIT

# Load the road data
BR262 <- readOGR(dsn = "~/Dropbox (Personal)/UBC/Side_Projects/Arnaud_Anteaters/Scripts/Roads/BR262")
...
# Res is bumped up here to help get a smoother PDF
...
#Currently assuming it's directly proportional to time spent on road. In other words, traffic volume is being ignored.
...
ggsave(FIG,
       ...
       dpi = 600,
       #bg = "transparent",
       file="Figures/Anteater_REZ_2.png")
